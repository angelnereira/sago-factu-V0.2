...
export function CreateUserModal({ organizations, isOpen, onClose }: CreateUserModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Refresh la página para mostrar el nuevo usuario
      router.refresh()
      onClose()
    } catch (err: any) {
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Crear Nuevo Usuario</h2>
            <button
              onClick={onClose}
